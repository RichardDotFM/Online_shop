...
import CreateSp from "../components/modals/CreateSp";
...
const Admin = () => {
  ...
  return (
    <Container className='d-flex flex-column'>
      <Button variant={'outline-dark'} className="mt-2" onClick={() => setTypeVisible(true)}>Добавить вид</Button>
      ...
      <CreateSp show={typeVisible} onHide={() => setTypeVisible(false)} />
